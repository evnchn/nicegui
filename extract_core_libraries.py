...
shutil.copy2(NODE_MODULES / 'engine.io-client' / 'dist' / 'engine.io.min.js', STATIC / 'engine.io.min.js')
shutil.copy2(NODE_MODULES / 'engine.io-client' / 'dist' / 'engine.io.min.js.map', STATIC / 'engine.io.min.js.map')
