...
class IconElement(Element):
    ...
    def bind_icon_to(self,
        ...
        bind_to(self, 'icon', target_object, name, forward, self_strict=False, other_strict=strict)
        return self
    ...
    def bind_icon_from(self,
        ...
        if not target_name:
            target_name = ('icon',)
        name = target_name if len(target_name) > 1 else target_name[0]
        bind_from(self, 'icon', target_object, name, backward, self_strict=False, other_strict=strict)
        return self
    ...
    def bind_icon(self,
        ...
        if not target_name:
            target_name = ('icon',)
        name = target_name if len(target_name) > 1 else target_name[0]
        bind(self, 'icon', target_object, name,
