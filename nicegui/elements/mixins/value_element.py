...
class ValueElement(Element):
    ...
    def bind_value_to(self,
        ...
        bind_to(self, 'value', target_object, name, forward, self_strict=False, other_strict=strict)
        return self
    ...
    def bind_value_from(self,
        ...
        if not target_name:
            target_name = ('value',)
        name = target_name if len(target_name) > 1 else target_name[0]
        bind_from(self, 'value', target_object, name, backward, self_strict=False, other_strict=strict)
        return self
    ...
    def bind_value(self,
        ...
        if not target_name:
            target_name = ('value',)
        name = target_name if len(target_name) > 1 else target_name[0]
        bind(self, 'value', target_object, name,
