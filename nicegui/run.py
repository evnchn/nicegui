...
async def cpu_bound(callback: Callable[P, R], *args: P.args, **kwargs: P.kwargs) -> R:
    ...
    try:
        ...
        raise e
    except BrokenProcessPool as e:  # pylint: disable=bad-except-order,duplicate-except  # noqa: E501  # BrokenProcessPool falls back to Exception when concurrent.futures is unavailable (Pyodide)
        try:
